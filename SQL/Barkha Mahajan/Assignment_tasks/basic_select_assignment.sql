...
SELECT MAX(Salary)'Max Sal',MIN(Salary) 'Min Sal' FROM Employees

--8.Write a query to get the average salary and number of employees in the employees table.

SELECT AVG(Salary) 'Avg Salary',COUNT(EmployeeID) 'Employees Count' FROM Employees

--9.Write a query to get the number of employees working with the company.

SELECT COUNT(EmployeeID) 'Employees in company' FROM Employees


--10.Write a query to get the number of jobs available in the employees table.

SELECT COUNT(DISTINCT JobID) 'Jobs available' FROM Employees
